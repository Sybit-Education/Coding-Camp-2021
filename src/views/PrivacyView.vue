<template>
  <v-container class="privacy__container">
    ...
    <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien- und
      ...
      Sybit GmbH bestellten Datenschutzbeauftragten oder einen anderen Mitarbeiter wenden.</p>
    ...
    <p>Ein soziales Netzwerk ist ein im Internet betriebener sozialer Treffpunkt, eine Online-Gemeinschaft, die es den
    ...
    <p>Betreibergesellschaft von Facebook ist die Facebook, Inc., 1 Hacker Way, Menlo Park, CA 94025, USA. Für die
      Verarbeitung personenbezogener Daten Verantwortlicher ist, wenn eine betroffene Person außerhalb der USA oder
      Kanada lebt, die Facebook Ireland Ltd., 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Ireland.</p>
    ...
    <p>Sofern die betroffene Person gleichzeitig bei Facebook eingeloggt ist, erkennt Facebook mit jedem Aufruf unserer
    ...
    <p>Facebook erhält über die Facebook-Komponente immer dann eine Information darüber, dass die betroffene Person
      ...
      unserer Internetseite aus ihrem Facebook-Account ausloggt.</p>
